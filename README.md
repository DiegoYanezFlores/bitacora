...
1. **Base de datos**: en Supabase → SQL Editor, ejecuta en orden `supabase/migrations/002_v2.sql`, `003_impacable.sql` y `004_hardening.sql`. Son idempotentes y no tocan los datos de la versión 1.
